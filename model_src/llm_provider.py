...
def get_gemini_llm(model_name="gemini-1.5-pro", temperature=0.7, convert_system_message_to_human=True, **kwargs):
    """
    ...
    Args:
        ...
        convert_system_message_to_human (bool): Whether to convert system messages.
    ...
    llm = ChatGoogleGenerativeAI(
        model=model_name,
        google_api_key=api_key, # Explicitly passing, though redundant if env var is set
